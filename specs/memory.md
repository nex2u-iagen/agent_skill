...
Crie um arquivo .md para conter um resumo antes de apagar o arquivo .db que passar do limite configurada (ex: últimas 10 interações), e serviro como memória de longo prazo e backup por usuário.
